...
An interim analysis will assess futility when a certain number of hospitalizations have occurred.
...
The primary endpoint is the number of years until hospitalization.
The futility analysis uses a Bayesian joint model to account for the association between survival and bilirubin levels (@Lawrence2016, @Brilleman2018, @Brilleman2020, @Goodrich2024).
